# Runs GUI with no working buttons
# Tests only one frame for buttons rather than two.
# Doesn't Work
...
class Home:
    def __init__(self):
        ...
        # Stats Button
        self.stats_button = Button(self.home_frame, text="STATS",
                                   font="Arial 18 bold", bg="blue",
                                   pady=10, padx=3.5)
        self.stats_button.grid(row=4, column=0)

        # Help Button
        self.help_button = Button(self.home_frame, text="HELP",
